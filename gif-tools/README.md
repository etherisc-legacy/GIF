...
@etherisc/gif-tools/0.1.6 linux-x64 node-v16.11.1
...
_See code: [src/commands/select-resources.js](https://github.com/etherisc/GIF/blob/v0.1.6/src/commands/select-resources.js)_
...
_See code: [src/commands/update-solc-version.js](https://github.com/etherisc/GIF/blob/v0.1.6/src/commands/update-solc-version.js)_
...
_See code: [src/commands/verify.js](https://github.com/etherisc/GIF/blob/v0.1.6/src/commands/verify.js)_
<!-- commandsstop -->
